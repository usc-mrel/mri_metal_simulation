function [im, params, ks, noise_params] = simulateVAT(t1map, t2map, pdmap, dfmap, params)
% SIMULATEVAT Simulates VAT MRI sequence for metal implants
%
% Inputs:
...
for slc = params.slices
    ...
    tic;
    fprintf('Simulating VAT slices: %d of %d\n', slc, params.Nslc);
...
fprintf('Total VAT simulation time: %.2f seconds\n', total_time);
